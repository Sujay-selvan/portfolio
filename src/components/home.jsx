        ...
        <>
            <div className="home relative font-anton h-[480px] flex flex-col items-center justify-center text-center  sm:h-160">
                ...
                <div className='flex gap-2 absolute bottom-7 sm:bottom-10'>
                    <button className='border pl-1 pr-1 text-[1.5rem] w-[130px] font-bold sm:w-[170px]'>About Me</button>
                    <button className='border pl-1 pr-1 text-[1.5rem] w-[130px] font-bold bg-black text-white sm:w-[170px]'>Contact</button>
                </div>
            </div>
        </>
    )
